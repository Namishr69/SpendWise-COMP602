  ...
  return (
    <AuthLayout variant="light">
      <div className="auth-panel">
        ...
        <div className="auth-form__divider">Or login with</div>
        <div className="auth-form__social">
          <button type="button" className="auth-form__social-button" onClick={handleGoogleSignIn} disabled={submitting} aria-label="Continue with Google">
            <GoogleIcon />
          </button>
          <button type="button" className="auth-form__social-button" onClick={handleAppleSignIn} disabled={submitting} aria-label="Continue with Apple">
            <AppleIcon />
          </button>
        </div>
      </div>
